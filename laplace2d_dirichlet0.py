...
fi_test1 = constantStrengthSource(x1[0], y1[0], x1[1], y1[1], 2, 2)
fi_test2 = constantStrengthSource(x1[1], y1[1], x1[0], y1[0], 2, 2)
print(fi_test1)
print(fi_test2)
plt.plot(x1[0], y1[0], x1[1], y1[1], 'b')
plt.plot(2, 2, 'r*')
plt.grid(linestyle='-', linewidth=0.5)
plt.quiver(xcolloc[0], ycolloc[0], nx[0], ny[0])
plt.show()
plt.plot(x1[1], y1[1], x1[0], y1[0], 'b')
plt.plot(2, 2, 'r*')
plt.grid(linestyle='-', linewidth=0.5)
plt.quiver(xcolloc[0], ycolloc[0], nx[0], ny[0])
plt.show()
